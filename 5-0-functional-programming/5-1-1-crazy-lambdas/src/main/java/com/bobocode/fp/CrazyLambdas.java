...
public class CrazyLambdas {
    ...
    public static BiFunction<String, Integer, String> stringMultiplier() {
        return (a, b) -> {
            String result = "";
            for(int counter = 0; counter < b; counter++) result += a;
            return result;
        };
    }
    ...
    public static BiFunction<IntUnaryOperator, IntPredicate, IntUnaryOperator> functionToConditionalFunction() {
        return ((intUnaryOperator, intPredicate) -> (value) -> intPredicate.test(value) ? intUnaryOperator.applyAsInt(value) : value);
    }
    ...
    public static BiFunction<Map<String, IntUnaryOperator>, String, IntUnaryOperator> functionLoader() {
        return (map, key) -> {
            ...
            else return IntUnaryOperator.identity();
        };
    }
    ...
    public static <T, U extends Comparable<? super U>> Comparator<T> thenComparing(
        ...
        return (value1, value2) -> {
            ...
            if(result == 0) return Comparator.comparing(mapper).compare(value1, value2);
            else return result;
        };
    }
